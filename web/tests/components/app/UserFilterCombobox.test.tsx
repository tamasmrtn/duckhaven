...
const USERS = [
  { id: 'u-1', email: 'marton@duckhaven.local', name: 'Marton', role: 'admin', theme: 'system', auth_provider: 'local', is_active: true, created_at: '2026-01-01T00:00:00Z' },
  { id: 'u-2', email: 'jess@duckhaven.local', name: 'Jess', role: 'user', theme: 'dark', auth_provider: 'local', is_active: true, created_at: '2026-01-01T00:00:00Z' },
]
