...
and referenced by [catalogs](catalogs.md) — one backend per catalog, fixed at creation. A
[workspace](workspaces.md) reaches storage through the catalogs it attaches.
